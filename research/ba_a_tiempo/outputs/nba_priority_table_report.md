...
## Demo de recálculo: 10 conversaciones (solo golden) vs. 225 (golden + sintéticas)
...
| situation_hint   | barrier_detected   | channel   | alt_id               |   n_offered |   success_rate |   acceptance_rate |
|:-----------------|:-------------------|:----------|:---------------------|------------:|---------------:|------------------:|
| S1               | DATE_MISMATCH      | CALL      | ALT-REMINDER-PAYLINK |           5 |         0.7143 |            0.8    |
| S1               | FORGOT             | CALL      | ALT-REMINDER-PAYLINK |         105 |         0.6729 |            0.819  |
| S0               | DATE_MISMATCH      | CALL      | ALT-CHANNEL-SUPPORT  |           1 |         0.6667 |            1      |
| S3               | LIQUIDITY          | SMS       | ALT-PARTIAL          |           1 |         0.6667 |            1      |
| S1               | OTHER              | CALL      | ALT-REMINDER-PAYLINK |           9 |         0.6364 |            0.7778 |
| S1               | DISPUTE            | CALL      | ALT-REMINDER-PAYLINK |           9 |         0.6364 |            0.7778 |
| S1               | LIQUIDITY          | CALL      | ALT-REMINDER-PAYLINK |          11 |         0.5385 |            0.6364 |
| S1               | REFUSAL            | CALL      | ALT-REMINDER-PAYLINK |           8 |         0.5    |            0.5    |
